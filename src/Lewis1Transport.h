/**
 *  @file Lewis1Transport.h
 *    Headers for the Lewis1Transport object, which models transport properties
 *    in ideal gas solutions using unity Lewis number for all species
 * 
 *    obtained from MixTransport.h  
 */
 ...
 *
 */
class Lewis1Transport : public GasTransport
{
...
public:
     ...
     */
    Lewis1Transport(const Lewis1Transport& right);
     ...
     */
    Lewis1Transport& operator=(const  Lewis1Transport& right);
